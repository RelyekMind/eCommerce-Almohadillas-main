...
const Header = () => {
  ...
  const { cart } = useCart();  // Asegúrate de que useCart esté importado y usado correctamente
      ...
      <div className="container mx-auto flex justify-between items-center">
                  ...
                  <a className="block p-2 hover:bg-gray-200">
                    <div className="flex items-center">
                      ...
                      <div className="ml-2">
                        ...
                        <p className="text-sm text-gray-600">{`$${product.price.toLocaleString('es-CL')}`}</p>
                      </div>
                    </div>
                  </a>
                </Link>
        ...
        <div className="flex items-center">
          ...
          <Link href="/cart" passHref legacyBehavior>
            <a className="flex items-center ml-4 p-2 border rounded text-black">
              <span className="mr-2 text-black">${totalCartPrice.toLocaleString('es-CL')}</span>
  ...
  <div className="container mx-auto flex justify-between space-x-4">
    <Link href="/" passHref legacyBehavior>
      <a className="text-lg text-black font-bold uppercase">Inicio</a>
    </Link>
    <Link href="/products" passHref legacyBehavior>
      <a className="text-lg text-black font-bold uppercase">Productos</a>
    </Link>
    <Link href="/sobre-nosotros" passHref legacyBehavior>
      <a className="text-lg text-black font-bold uppercase">Sobre Nosotros</a>
    </Link>
  </div>
</nav>
    </header>
